...
def build_url(params: dict) -> str:
    ...
    lastnikov = params.get('lastnikov', '')
    return get_base_url() + f"/Ads/results.asp?znamka={params['znamka']}&model={params['model']}&modelID=&tip=&znamka2=&model2=&tip2=&znamka3=&model3=&tip3=" \
        ...
        f"&presort={presort}&tipsort={tipsort}&stran={page_num}&subSORT={sort}&subTIPSORT={sort_order}&subLOCATION={params['subLOCATION']}&subSELLER=2&lastnikov={lastnikov}"
